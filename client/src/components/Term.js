  ...
  render() {
    return (
      <div>
        ...
        <p>
          EduGator ("us", "we", or "our") operates the EduGator.com website
        ...
        <p>
          ...
          choices you have associated with that data. Our Privacy Policy is
          managed by the for EduGator is{' '}
        ...
        <p>
          ...
          as in our Terms and Conditions, accessible from EduGator.com
        </p>
        ...
        <ul>
          <li>
            ...
            <p>Service is the EduGator.com website operated by EduGator</p>
          </li>
          <li>
            <p>
        ...
        <p>EduGator uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          EduGator will take all steps reasonably necessary to ensure that your
        ...
        <p>
          EduGator may disclose your Personal Data in the good faith belief that
          such action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of EduGator</li>
          <li>
        ...
        <ul>
          <li>By visiting this page on our website: EduGator.com</li>
          <li>Or call us by +1-888-EDUGATR</li>
        </ul>

        <Link to="/signup">
          {' '}
          <h4>I read and agree </h4>{' '}
        </Link>
      </div>
    )
  }
